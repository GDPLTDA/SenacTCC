...
Nesse capítulo é feita uma revisão no estado da arte dos algoritmos de roteamento de veículose a aplicação de algoritmos genéticos para mesma finalidade.
