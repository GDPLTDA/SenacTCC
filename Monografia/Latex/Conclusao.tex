...
A solução desenvolvida leva em consideração a densidade do trafego, utilizando de recursos do google maps para escolher qual nível de gravidade do transito devera ser utilizado na simulação. Estas são três, \textbf{Média}, \textbf{Otimista} e \textbf{Pessimista}.
