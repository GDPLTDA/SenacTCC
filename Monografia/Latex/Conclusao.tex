...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.9]{../../Analise/Roteiro1.png}}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro1/DisplacementMutation.png}}
	\captionof{figure}{Mutação DisplacementMutation}
	\label{fig:Roteiro1-G500P50-DisplacementMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro1/InsertionMutation.png}}
	\captionof{figure}{Mutação InsertionMutation}
	\label{fig:Roteiro1-G500P50-InsertionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro1/InversionMutation.png}}
	\captionof{figure}{Mutação InversionMutation}
	\label{fig:Roteiro1-G500P50-InversionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro1/SwapMutation.png}}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro1/DisplacementMutation.png}}
	\captionof{figure}{Mutação DisplacementMutation}
	\label{fig:Roteiro1-G1000P100-DisplacementMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro1/InsertionMutation.png}}
	\captionof{figure}{Mutação InsertionMutation}
	\label{fig:Roteiro1-G1000P100-InsertionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro1/InversionMutation.png}}
	\captionof{figure}{Mutação InversionMutation}
	\label{fig:Roteiro1-G1000P100-InversionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro1/SwapMutation.png}}
	\captionof{figure}{Mutação SwapMutation}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=1.0]{../../Analise/Roteiro2.png}}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro2/DisplacementMutation.png}}
	\captionof{figure}{Mutação DisplacementMutation}
	\label{fig:Roteiro2-G500P50-DisplacementMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro2/InsertionMutation.png}}
	\captionof{figure}{Mutação InsertionMutation}
	\label{fig:Roteiro2-G500P50-InsertionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro2/InversionMutation.png}}
	\captionof{figure}{Mutação InversionMutation}
	\label{fig:Roteiro2-G500P50-InversionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro2/SwapMutation.png}}
	\captionof{figure}{Mutação SwapMutation}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro2/DisplacementMutation.png}}
	\captionof{figure}{Mutação DisplacementMutation}
	\label{fig:Roteiro2-G1000P100-DisplacementMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro2/InsertionMutation.png}}
	\captionof{figure}{Mutação InsertionMutation}
	\label{fig:Roteiro2-G1000P100-InsertionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro2/InversionMutation.png}}
	\captionof{figure}{Mutação InversionMutation}
	\label{fig:Roteiro2-G1000P100-InversionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro2/SwapMutation.png}}
	\captionof{figure}{Mutação SwapMutation}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=1.0]{../../Analise/Roteiro3.png}}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro3/DisplacementMutation.png}}
	\captionof{figure}{Mutação DisplacementMutation}
	\label{fig:Roteiro3-G500P50-DisplacementMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro3/InsertionMutation.png}}
	\captionof{figure}{Mutação InsertionMutation}
	\label{fig:Roteiro3-G500P50-InsertionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro3/InversionMutation.png}}
	\captionof{figure}{Mutação InversionMutation}
	\label{fig:Roteiro3-G500P50-InversionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro3/SwapMutation.png}}
	\captionof{figure}{Mutação SwapMutation}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro3/DisplacementMutation.png}}
	\captionof{figure}{Mutação DisplacementMutation}
	\label{fig:Roteiro3-G1000P100-DisplacementMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro3/InsertionMutation.png}}
	\captionof{figure}{Mutação InsertionMutation}
	\label{fig:Roteiro3-G1000P100-InsertionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro3/InversionMutation.png}}
	\captionof{figure}{Mutação InversionMutation}
	\label{fig:Roteiro3-G1000P100-InversionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro3/SwapMutation.png}}
	\captionof{figure}{Mutação SwapMutation}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=1.2]{../../Analise/Roteiro4.png}}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro4/DisplacementMutation.png}}
	\captionof{figure}{Mutação DisplacementMutation}
	\label{fig:Roteiro43-G500P50-DisplacementMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro4/InsertionMutation.png}}
	\captionof{figure}{Mutação InsertionMutation}
	\label{fig:Roteiro4-G500P50-InsertionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro4/InversionMutation.png}}
	\captionof{figure}{Mutação InversionMutation}
	\label{fig:Roteiro4-G500P50-InversionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G500P50/Roteiro4/SwapMutation.png}}
	\captionof{figure}{Mutação SwapMutation}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro4/DisplacementMutation.png}}
	\captionof{figure}{Mutação DisplacementMutation}
	\label{fig:Roteiro4-G1000P100-DisplacementMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro4/InsertionMutation.png}}
	\captionof{figure}{Mutação InsertionMutation}
	\label{fig:Roteiro4-G1000P100-InsertionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro4/InversionMutation.png}}
	\captionof{figure}{Mutação InversionMutation}
	\label{fig:Roteiro4-G1000P100-InversionMutation}
\end{center}
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{../../Analise/G1000P100/Roteiro4/SwapMutation.png}}
	\captionof{figure}{Mutação SwapMutation}
