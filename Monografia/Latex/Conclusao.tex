...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{ibagens/Senac-Entregador3.png}}
	\captionof{figure}{Resultado do Entregador 3}
	\label{fig:Senac-Entregador3}
\end{center}
...
\begin{center}
	\makebox[\linewidth]{
		\includegraphics[keepaspectratio=true,scale=0.8]{ibagens/Extra-Entregador2.png}}
	\captionof{figure}{Resultado do Entregador 2}
