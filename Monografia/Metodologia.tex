...
\begin{table}[]
	...
	\begin{tabular}{lllll}
		...
		FitnessHeuristic                                  & \cellcolor[HTML]{FFFC9E}106 & 62.542                         & \cellcolor[HTML]{FFFC9E}3  & \cellcolor[HTML]{FFFC9E}59  \\
		FitnessWithCirclicValidation                      & 991                         & \cellcolor[HTML]{FFFC9E}34.119 & 91                         & 191                         \\
		FitnessWithCollisionDetection                     & 1.467                       & \cellcolor[HTML]{FFFC9E}30.405 & 105                        & 202                         \\
		FitnessWithCollisionDetectionAndCirclicValidation & \cellcolor[HTML]{FFFC9E}510 & 44.943                         & \cellcolor[HTML]{FFFC9E}21 & \cellcolor[HTML]{FFFC9E}103 \\
...
\begin{table}[]
	...
	\begin{tabular}{lllll}
		...
		MutateDIVM        & \cellcolor[HTML]{FFFC9E}753 & \cellcolor[HTML]{FFFC9E}42.161 & \cellcolor[HTML]{FFFC9E}26 & \cellcolor[HTML]{FFFC9E}87 \\
		MutateDM          & \cellcolor[HTML]{FFFC9E}617 & 44.924                         & \cellcolor[HTML]{FFFC9E}20 & \cellcolor[HTML]{FFFC9E}80 \\
		MutateEM          & 781                         & 43.362                         & 35                         & 74                         \\
		MutateIM          & 728                         & 43.324                         & 25                         & 73                         \\
		MutateIVM         & 813                         & 44.133                         & 34                         & 85                         \\
		MutateSM          & 749                         & \cellcolor[HTML]{FFFC9E}40.356 & 30                         & 80                         \\
		\textbf{Total}    & \textbf{768}                & \textbf{43.002}                & \textbf{220}               & \textbf{555}              
	\end{tabular}
\end{table}
...
\begin{table}[]
	...
	\begin{tabular}{lllll}
		...
		CrossoverOBX              & \cellcolor[HTML]{FFFC9E}167 & 56.548                         & 5              & \cellcolor[HTML]{FFFC9E}121 \\
		CrossoverPBX              & 1.777                       & \cellcolor[HTML]{FFFC9E}33.921 & 200            & 259                         \\
		CrossoverSimple           & \cellcolor[HTML]{FFFC9E}362 & \cellcolor[HTML]{FFFC9E}38.537 & 15             & \cellcolor[HTML]{FFFC9E}175 \\
