...
Desenvolvemos uma ferramenta para geração de mapas de forma automática, aonde escolhemos se queremos um mapa totalmente aleatório, o tamanho minimo do caminho e se gostaria de aplicar um padrão de repetição.

O tamanho dos mapas gerados foi de 30x30, para os mapas com padrão utilizamos um padrão de repetição de tamanho 5x5.
