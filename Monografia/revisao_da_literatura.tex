...
\begin{description}
    \item[Figura 1] Consiste em um nó inicial s e mais tres outros nós (n1,n2,n3). As arestras contem a direção e o custo do trajeto. Se partirmos do algoritimo A* para produzir um subgrafo do melhor caminho, partindo de s podemos ir para n1 e n2, os valores de g(n1) e g(n2) são respectivamente 3 e 7. Supondo que A* expanda n1, sucedindo por n2 e n3, nesse ponto g(n3)=3+2=5,o valor de g(n2) é diminuido pois um caminho de menor custo foi encontrado  3+3=6, o valor de g(n1) continua sendo 3. 
