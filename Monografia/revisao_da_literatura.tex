...
\textbf{avaliação}: avalia-se a aptidão das soluções, os indivíduos da população s é feita uma analise para que se estabeleça quão bem elas respondem ao problema proposto.
