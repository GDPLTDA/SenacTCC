...
O principal objetivo deste trabalho é propor um modelo de busca de caminho do algoritmo A* com IA em uma arquitetura paralela, A* tem a utilização muito popular em jogos eletrônicos, e existe uma necessidade na melhoria do desempenho destes algoritmos nesse meio. \cite{Ross_Graham}

A primeira parte do modelo que iremos propor, trata-se da utilização de inteligência artificial, em especifico, algoritmos genéticos. A arquitetura híbrida é foi demonstrada demonstrada indicando sucesso na melhoria de desempenho. \cite{Ryan}
